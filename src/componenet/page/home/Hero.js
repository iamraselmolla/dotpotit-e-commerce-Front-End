    ...
    return (
        <div className="mx-auto p-4">
            ...
            <div className="w-full lg:flex lg:space-x-4">
                ...
                {/* Right Column - Additional Products */}
                <div className="bg-white p-4 w-full lg:w-1/3 rounded-lg shadow">
                    {/* Parent div containing both image divs */}
                    <div className="lg:space-y-6 md:flex md:gap-4">
                        {/* First image div with content aligned to the right */}
                        <div className="h-52 sm:mb-3 relative flex w-full md:w-1/2 items-center justify-end rounded-lg shadow-lg"
                            style={{
                        ...
                        >
                            ...
                            <div className="bg-opacity-50 p-6 text-right w-full md:w-2/3">
                        ...
                        <div className="h-52 w-full md:w-1/2 relative flex items-center justify-start rounded-lg shadow-lg"
                            style={{
                        ...
                        >
                            ...
                            <div className="w-full md:w-1/2 bg-opacity-50 p-6 text-white text-left">
