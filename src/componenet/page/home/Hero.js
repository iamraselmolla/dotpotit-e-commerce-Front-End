    ...
    return (
        <div className="container mx-auto p-4">
            ...
            <div className="md:hidden grid grid-cols-1 gap-4">
                ...
                >
                    {/* Overlay Content */}
                    <div className="bg-opacity-50 w-full h-full p-6 text-white">
                        <h2 className="text-2xl font-bold mb-2">Noise Cancelling Headphone</h2>
                        <p className="mb-2">Boso Over-Ear Headphone</p>
                        <p className="mb-4">WiFi, Voice Assistant, Low Latency Game Mode</p>
                        <button className="bg-white text-black py-2 px-4 rounded-lg">BUY NOW</button>
                    </div>
                </div>
                ...
                <div className="flex flex-col gap-4">
                    <div className="relative h-36 w-full">
                        ...
                        <div className="absolute inset-0 flex flex-col pl-6 rounded-lg text-white">
                            <h4 className="text-lg font-bold">Sono Playgo 5 from <span className='text-green-500'>$569</span></h4>
                            <a href="#" className="text-blue-600 hover:text-blue-800 underline-none">Discover Now</a>
                        </div>
                    </div>
                    <div className="relative h-36 w-full">
                        <img src="images/hero1.png" alt="Image 1" className="object-cover h-full w-full rounded-lg" />
                        <div className="absolute inset-0 flex flex-col pl-6 rounded-lg text-white">
                            <h4 className="text-lg font-bold">Logitek Bluetooth <span className='text-yellow-400'>Keyboard</span></h4>
                            <a href="#" className="text-blue-600 hover:text-blue-800 underline-none">View More</a>
                        </div>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 gap-4">
                    <div
                        className="h-52 relative flex items-center justify-center rounded-lg shadow-lg"
                        style={{
                            backgroundImage: 'url("/images/hero3.png")', // Update with your image path
                            backgroundSize: 'cover',
                            backgroundPosition: 'center',
                    ...
                    >
                        <div className="w-full bg-opacity-50 p-6 text-center text-white">
                            <h2 className="text-lg font-bold">Sport Water<br />Resistance Watch</h2>
                            <button className="bg-black text-white py-2 px-4 rounded-lg">Shop Now</button>
                        </div>
                    </div>
                    ...
                    >
                        <div className="w-full bg-opacity-50 p-6 text-center text-white">
                            <h2 className="text-lg font-bold">OKODo hero 11+ black</h2>
                            <p className="text-green-500 font-bold">from $160</p>
                        </div>
                    </div>
                </div>
